...
class Bouchonnage {
    var accounts = [[ "1" , "test 1 SA" , "test 1" , "aa 1" , "bb 1" , "cc 1" , "dd 1" , "www.quelquechose1.com" , "0699048436" , "0603403171" , "quelquechose1" , "quelquepart1" , "10 place de quelquepart1" , "1" , "Belgium" , "customer", "1" ]]
    func remplirAccounts() {
        self.accounts.append([ "2" , "test 2 SA" , "test 2" , "aa 2" , "bb 2" , "cc 2" , "dd 2" , "www.quelquechose2.com" , "0609361823" , "0668713654" , "quelquechose2" , "quelquepart2" , "10 place de quelquepart2" , "1" , "Spain" , "customer", "0" ])
        self.accounts.append([ "3" , "test 3 SA" , "test 3" , "aa 3" , "bb 3" , "cc 3" , "dd 3" , "www.quelquechose3.com" , "0679371100" , "0686356394" , "quelquechose3" , "quelquepart3" , "10 place de quelquepart3" , "1" , "Spain" , "customer", "0" ])
        self.accounts.append([ "4" , "test 4 SA" , "test 4" , "aa 4" , "bb 4" , "cc 4" , "dd 4" , "www.quelquechose4.com" , "0633179545" , "0607333916" , "quelquechose4" , "quelquepart4" , "10 place de quelquepart4" , "1" , "Spain" , "customer", "0" ])
        self.accounts.append([ "5" , "test 5 SA" , "test 5" , "aa 5" , "bb 5" , "cc 5" , "dd 5" , "www.quelquechose5.com" , "0624483268" , "0600862008" , "quelquechose5" , "quelquepart5" , "10 place de quelquepart5" , "1" , "france" , "customer", "0" ])
        self.accounts.append([ "6" , "test 6 SA" , "test 6" , "aa 6" , "bb 6" , "cc 6" , "dd 6" , "www.quelquechose6.com" , "0608552874" , "0684792529" , "quelquechose6" , "quelquepart6" , "10 place de quelquepart6" , "1" , "Belgium" , "customer", "0" ])
        self.accounts.append([ "7" , "test 7 SA" , "test 7" , "aa 7" , "bb 7" , "cc 7" , "dd 7" , "www.quelquechose7.com" , "0637049276" , "0615188025" , "quelquechose7" , "quelquepart7" , "10 place de quelquepart7" , "1" , "Belgium" , "customer", "0" ])
        self.accounts.append([ "8" , "test 8 SA" , "test 8" , "aa 8" , "bb 8" , "cc 8" , "dd 8" , "www.quelquechose8.com" , "0690976146" , "0684653193" , "quelquechose8" , "quelquepart8" , "10 place de quelquepart8" , "2" , "Spain" , "customer", "0" ])
        self.accounts.append([ "9" , "test 9 SA" , "test 9" , "aa 9" , "bb 9" , "cc 9" , "dd 9" , "www.quelquechose9.com" , "0693695904" , "0634966259" , "quelquechose9" , "quelquepart9" , "10 place de quelquepart9" , "2" , "Spain" , "customer", "0" ])
        self.accounts.append([ "10" , "test 10 SA" , "test 10" , "aa 10" , "bb 10" , "cc 10" , "dd 10" , "www.quelquechose10.com" , "0687240184" , "0650658062" , "quelquechose10" , "quelquepart10" , "10 place de quelquepart10" , "2" , "Spain" , "customer", "0" ])
        self.accounts.append([ "11" , "test 11 SA" , "test 11" , "aa 11" , "bb 11" , "cc 11" , "dd 11" , "www.quelquechose11.com" , "0671717123" , "0659391887" , "quelquechose11" , "quelquepart11" , "10 place de quelquepart11" , "2" , "Belgium" , "customer", "0" ])
        self.accounts.append([ "12" , "test 12 SA" , "test 12" , "aa 12" , "bb 12" , "cc 12" , "dd 12" , "www.quelquechose12.com" , "0607804612" , "0693518703" , "quelquechose12" , "quelquepart12" , "10 place de quelquepart12" , "2" , "Belgium" , "customer", "0" ])
        self.accounts.append([ "13" , "test 13 SA" , "test 13" , "aa 13" , "bb 13" , "cc 13" , "dd 13" , "www.quelquechose13.com" , "0619417028" , "0627337645" , "quelquechose13" , "quelquepart13" , "10 place de quelquepart13" , "10" , "france" , "customer", "0" ])
        self.accounts.append([ "14" , "test 14 SA" , "test 14" , "aa 14" , "bb 14" , "cc 14" , "dd 14" , "www.quelquechose14.com" , "0685931371" , "0687037314" , "quelquechose14" , "quelquepart14" , "10 place de quelquepart14" , "10" , "Belgium" , "customer", "0" ])
        self.accounts.append([ "15" , "test 15 SA" , "test 15" , "aa 15" , "bb 15" , "cc 15" , "dd 15" , "www.quelquechose15.com" , "0692382455" , "0645870247" , "quelquechose15" , "quelquepart15" , "10 place de quelquepart15" , "10" , "Belgium" , "customer", "0" ])
        self.accounts.append([ "16" , "test 16 SA" , "test 16" , "aa 16" , "bb 16" , "cc 16" , "dd 16" , "www.quelquechose16.com" , "0671841939" , "0630812645" , "quelquechose16" , "quelquepart16" , "10 place de quelquepart16" , "10" , "Spain" , "customer", "0" ])
        self.accounts.append([ "17" , "test 17 SA" , "test 17" , "aa 17" , "bb 17" , "cc 17" , "dd 17" , "www.quelquechose17.com" , "0669835481" , "0698275385" , "quelquechose17" , "quelquepart17" , "10 place de quelquepart17" , "10" , "Spain" , "customer", "0" ])
        self.accounts.append([ "18" , "test 18 SA" , "test 18" , "aa 18" , "bb 18" , "cc 18" , "dd 18" , "www.quelquechose18.com" , "0621502205" , "0600152571" , "quelquechose18" , "quelquepart18" , "10 place de quelquepart18" , "10" , "france" , "customer", "0" ])
        self.accounts.append([ "19" , "test 19 SA" , "test 19" , "aa 19" , "bb 19" , "cc 19" , "dd 19" , "www.quelquechose19.com" , "0644763771" , "0625007638" , "quelquechose19" , "quelquepart19" , "10 place de quelquepart19" , "10" , "france" , "customer", "0" ])
        self.accounts.append([ "20" , "test 20 SA" , "test 20" , "aa 20" , "bb 20" , "cc 20" , "dd 20" , "www.quelquechose20.com" , "0601445659" , "0689888827" , "quelquechose20" , "quelquepart20" , "10 place de quelquepart20" , "8" , "france" , "customer", "0" ])
        self.accounts.append([ "21" , "test 21 SA" , "test 21" , "aa 21" , "bb 21" , "cc 21" , "dd 21" , "www.quelquechose21.com" , "0615945512" , "0676350351" , "quelquechose21" , "quelquepart21" , "10 place de quelquepart21" , "8" , "Spain" , "customer", "0" ])
        self.accounts.append([ "22" , "test 22 SA" , "test 22" , "aa 22" , "bb 22" , "cc 22" , "dd 22" , "www.quelquechose22.com" , "0672764438" , "0630817988" , "quelquechose22" , "quelquepart22" , "10 place de quelquepart22" , "8" , "france" , "customer", "0" ])
        self.accounts.append([ "23" , "test 23 SA" , "test 23" , "aa 23" , "bb 23" , "cc 23" , "dd 23" , "www.quelquechose23.com" , "0691872088" , "0671745537" , "quelquechose23" , "quelquepart23" , "10 place de quelquepart23" , "8" , "france" , "customer", "0" ])
        self.accounts.append([ "24" , "test 24 SA" , "test 24" , "aa 24" , "bb 24" , "cc 24" , "dd 24" , "www.quelquechose24.com" , "0613784691" , "0662345883" , "quelquechose24" , "quelquepart24" , "10 place de quelquepart24" , "8" , "Spain" , "customer", "0" ])
        self.accounts.append([ "25" , "test 25 SA" , "test 25" , "aa 25" , "bb 25" , "cc 25" , "dd 25" , "www.quelquechose25.com" , "0671449132" , "0600130900" , "quelquechose25" , "quelquepart25" , "10 place de quelquepart25" , "0" , "france" , "customer", "0" ])
        self.accounts.append([ "26" , "test 26 SA" , "test 26" , "aa 26" , "bb 26" , "cc 26" , "dd 26" , "www.quelquechose26.com" , "0692917165" , "0608285652" , "quelquechose26" , "quelquepart26" , "10 place de quelquepart26" , "0" , "france" , "customer", "0" ])
        self.accounts.append([ "27" , "test 27 SA" , "test 27" , "aa 27" , "bb 27" , "cc 27" , "dd 27" , "www.quelquechose27.com" , "0625622342" , "0681854347" , "quelquechose27" , "quelquepart27" , "10 place de quelquepart27" , "0" , "france" , "customer", "0" ])
        self.accounts.append([ "28" , "test 28 SA" , "test 28" , "aa 28" , "bb 28" , "cc 28" , "dd 28" , "www.quelquechose28.com" , "0651612613" , "0659849221" , "quelquechose28" , "quelquepart28" , "10 place de quelquepart28" , "0" , "france" , "customer", "0" ])
        self.accounts.append([ "29" , "test 29 SA" , "test 29" , "aa 29" , "bb 29" , "cc 29" , "dd 29" , "www.quelquechose29.com" , "0677981017" , "0667140620" , "quelquechose29" , "quelquepart29" , "10 place de quelquepart29" , "0" , "france" , "customer", "0" ])
        self.accounts.append([ "30" , "test 30 SA" , "test 30" , "aa 30" , "bb 30" , "cc 30" , "dd 30" , "www.quelquechose30.com" , "0674149639" , "0615779217" , "quelquechose30" , "quelquepart30" , "10 place de quelquepart30" , "0" , "france" , "customer", "0" ])
        self.accounts.append([ "31" , "test 31 SA" , "test 31" , "aa 31" , "bb 31" , "cc 31" , "dd 31" , "www.quelquechose31.com" , "0695264007" , "0602910100" , "quelquechose31" , "quelquepart31" , "10 place de quelquepart31" , "0" , "france" , "customer", "0" ])
        self.accounts.append([ "32" , "test 32 SA" , "test 32" , "aa 32" , "bb 32" , "cc 32" , "dd 32" , "www.quelquechose32.com" , "0655354640" , "0655804073" , "quelquechose32" , "quelquepart32" , "10 place de quelquepart32" , "0" , "france" , "customer", "0" ])
        self.accounts.append([ "33" , "test 33 SA" , "test 33" , "aa 33" , "bb 33" , "cc 33" , "dd 33" , "www.quelquechose33.com" , "0616359443" , "0615257942" , "quelquechose33" , "quelquepart33" , "10 place de quelquepart33" , "0" , "Spain" , "customer", "0" ])
        self.accounts.append([ "34" , "test 34 SA" , "test 34" , "aa 34" , "bb 34" , "cc 34" , "dd 34" , "www.quelquechose34.com" , "0660166834" , "0697122217" , "quelquechose34" , "quelquepart34" , "10 place de quelquepart34" , "0" , "Belgium" , "customer", "0" ])
        self.accounts.append([ "35" , "test 35 SA" , "test 35" , "aa 35" , "bb 35" , "cc 35" , "dd 35" , "www.quelquechose35.com" , "0684737817" , "0619481994" , "quelquechose35" , "quelquepart35" , "10 place de quelquepart35" , "0" , "france" , "customer", "0" ])
        self.accounts.append([ "36" , "test 36 SA" , "test 36" , "aa 36" , "bb 36" , "cc 36" , "dd 36" , "www.quelquechose36.com" , "0696465016" , "0607967779" , "quelquechose36" , "quelquepart36" , "10 place de quelquepart36" , "0" , "Belgium" , "customer", "0" ])
        self.accounts.append([ "37" , "test 37 SA" , "test 37" , "aa 37" , "bb 37" , "cc 37" , "dd 37" , "www.quelquechose37.com" , "0635511165" , "0688745886" , "quelquechose37" , "quelquepart37" , "10 place de quelquepart37" , "0" , "Belgium" , "customer", "0" ])
        self.accounts.append([ "38" , "test 38 SA" , "test 38" , "aa 38" , "bb 38" , "cc 38" , "dd 38" , "www.quelquechose38.com" , "0601839135" , "0659373123" , "quelquechose38" , "quelquepart38" , "10 place de quelquepart38" , "0" , "Spain" , "customer", "0" ])
        self.accounts.append([ "39" , "test 39 SA" , "test 39" , "aa 39" , "bb 39" , "cc 39" , "dd 39" , "www.quelquechose39.com" , "0646144724" , "0666074826" , "quelquechose39" , "quelquepart39" , "10 place de quelquepart39" , "0" , "france" , "customer", "0" ])
        self.accounts.append([ "40" , "test 40 SA" , "test 40" , "aa 40" , "bb 40" , "cc 40" , "dd 40" , "www.quelquechose40.com" , "0609529849" , "0630429737" , "quelquechose40" , "quelquepart40" , "10 place de quelquepart40" , "0" , "Spain" , "customer", "0" ])
        self.accounts.append([ "41" , "test 41 SA" , "test 41" , "aa 41" , "bb 41" , "cc 41" , "dd 41" , "www.quelquechose41.com" , "0634218527" , "0619093255" , "quelquechose41" , "quelquepart41" , "10 place de quelquepart41" , "0" , "france" , "customer", "0" ])
        self.accounts.append([ "42" , "test 42 SA" , "test 42" , "aa 42" , "bb 42" , "cc 42" , "dd 42" , "www.quelquechose42.com" , "0640532116" , "0649626675" , "quelquechose42" , "quelquepart42" , "10 place de quelquepart42" , "0" , "france" , "customer", "0" ])
        self.accounts.append([ "43" , "test 43 SA" , "test 43" , "aa 43" , "bb 43" , "cc 43" , "dd 43" , "www.quelquechose43.com" , "0613026847" , "0603724240" , "quelquechose43" , "quelquepart43" , "10 place de quelquepart43" , "0" , "france" , "customer", "0" ])
        self.accounts.append([ "44" , "test 44 SA" , "test 44" , "aa 44" , "bb 44" , "cc 44" , "dd 44" , "www.quelquechose44.com" , "0683331747" , "0675546770" , "quelquechose44" , "quelquepart44" , "10 place de quelquepart44" , "0" , "Belgium" , "customer", "0" ])
        self.accounts.append([ "45" , "test 45 SA" , "test 45" , "aa 45" , "bb 45" , "cc 45" , "dd 45" , "www.quelquechose45.com" , "0628847870" , "0697263729" , "quelquechose45" , "quelquepart45" , "10 place de quelquepart45" , "0" , "Spain" , "customer", "0" ])
        self.accounts.append([ "46" , "test 46 SA" , "test 46" , "aa 46" , "bb 46" , "cc 46" , "dd 46" , "www.quelquechose46.com" , "0658497205" , "0609480380" , "quelquechose46" , "quelquepart46" , "10 place de quelquepart46" , "0" , "Spain" , "customer", "0" ])
        self.accounts.append([ "47" , "test 47 SA" , "test 47" , "aa 47" , "bb 47" , "cc 47" , "dd 47" , "www.quelquechose47.com" , "0650188000" , "0646979446" , "quelquechose47" , "quelquepart47" , "10 place de quelquepart47" , "0" , "france" , "customer", "0" ])
        self.accounts.append([ "48" , "test 48 SA" , "test 48" , "aa 48" , "bb 48" , "cc 48" , "dd 48" , "www.quelquechose48.com" , "0618066387" , "0692980412" , "quelquechose48" , "quelquepart48" , "10 place de quelquepart48" , "0" , "Spain" , "customer", "0" ])
        self.accounts.append([ "49" , "test 49 SA" , "test 49" , "aa 49" , "bb 49" , "cc 49" , "dd 49" , "www.quelquechose49.com" , "0612339199" , "0638830063" , "quelquechose49" , "quelquepart49" , "10 place de quelquepart49" , "0" , "Belgium" , "customer", "0" ])
        self.accounts.append([ "50" , "test 50 SA" , "test 50" , "aa 50" , "bb 50" , "cc 50" , "dd 50" , "www.quelquechose50.com" , "0621440940" , "0638889615" , "quelquechose50" , "quelquepart50" , "10 place de quelquepart50" , "0" , "Spain" , "customer", "0" ])
        self.accounts.append([ "51" , "test 51 SA" , "test 51" , "aa 51" , "bb 51" , "cc 51" , "dd 51" , "www.quelquechose51.com" , "0684981131" , "0666442077" , "quelquechose51" , "quelquepart51" , "10 place de quelquepart51" , "0" , "Spain" , "customer", "0" ])
        self.accounts.append([ "52" , "test 52 SA" , "test 52" , "aa 52" , "bb 52" , "cc 52" , "dd 52" , "www.quelquechose52.com" , "0690377293" , "0678368502" , "quelquechose52" , "quelquepart52" , "10 place de quelquepart52" , "0" , "Belgium" , "customer", "0" ])
        self.accounts.append([ "53" , "test 53 SA" , "test 53" , "aa 53" , "bb 53" , "cc 53" , "dd 53" , "www.quelquechose53.com" , "0601983197" , "0672632915" , "quelquechose53" , "quelquepart53" , "10 place de quelquepart53" , "0" , "france" , "customer", "0" ])
        self.accounts.append([ "54" , "test 54 SA" , "test 54" , "aa" , "bb 54" , "cc 54" , "dd 54" , "www.quelquechose54.com" , "0618052139" , "0686838807" , "quelquechose54" , "quelquepart54" , "10 place de quelquepart54" , "0" , "Belgium" , "customer", "0" ])
    }
    func viderAccounts(){
        self.accounts = [[ "1" , "test 1 SA" , "test 1" , "aa 1" , "bb 1" , "cc 1" , "dd 1" , "www.quelquechose1.com" , "0699048436" , "0603403171" , "quelquechose1" , "quelquepart1" , "10 place de quelquepart1" , "1" , "Belgium" , "customer", "1" ]]
    }
    func remplirTableauAccount() -> [AccountModel]{
        ...
        for oneAccount in self.accounts{
            ...
            var favoriteAccount: Int = oneAccount[16].toInt()!
            println(typeAccount)
    ...
    func remplirOpportunities() {
        self.opportunities.append([ "2" , "test nom 2" , "2221037" , "2015-10-22" , "May be" , "0" ])
        self.opportunities.append([ "3" , "test nom 3" , "8063510" , "2015-07-16" , "May be" , "95" ])
        self.opportunities.append([ "4" , "test nom 4" , "2663360" , "2015-02-13" , "Good" , "60" ])
        self.opportunities.append([ "5" , "test nom 5" , "8353155" , "2015-12-25" , "Got it" , "50" ])
        self.opportunities.append([ "6" , "test nom 6" , "6485872" , "2015-05-20" , "Good" , "5" ])
        self.opportunities.append([ "7" , "test nom 7" , "8135020" , "2015-05-02" , "Got it" , "30" ])
        self.opportunities.append([ "8" , "test nom 8" , "6449395" , "2015-11-06" , "Good" , "65" ])
        self.opportunities.append([ "9" , "test nom 9" , "6823630" , "2015-07-12" , "May be" , "75" ])
        self.opportunities.append([ "10" , "test nom 10" , "9750878" , "2015-12-27" , "Got it" , "15" ])
        self.opportunities.append([ "11" , "test nom 11" , "9739484" , "2015-04-15" , "Got it" , "65" ])
        self.opportunities.append([ "12" , "test nom 12" , "2568394" , "2015-02-17" , "Good" , "55" ])
        self.opportunities.append([ "13" , "test nom 13" , "8934783" , "2015-07-25" , "Good" , "25" ])
        self.opportunities.append([ "14" , "test nom 14" , "879077" , "2015-11-16" , "May be" , "35" ])
        self.opportunities.append([ "15" , "test nom 15" , "7827800" , "2015-01-09" , "Got it" , "45" ])
        self.opportunities.append([ "16" , "test nom 16" , "4281868" , "2015-01-10" , "No" , "50" ])
        self.opportunities.append([ "17" , "test nom 17" , "9371268" , "2015-09-03" , "No" , "25" ])
        self.opportunities.append([ "18" , "test nom 18" , "9045262" , "2015-06-24" , "May be" , "35" ])
        self.opportunities.append([ "19" , "test nom 19" , "5781705" , "2015-11-01" , "Good" , "90" ])
        self.opportunities.append([ "20" , "test nom 20" , "9392223" , "2015-10-17" , "Got it" , "85" ])
        self.opportunities.append([ "21" , "test nom 21" , "1594370" , "2015-01-20" , "No" , "0" ])
        self.opportunities.append([ "22" , "test nom 22" , "1718478" , "2015-02-03" , "Good" , "5" ])
        self.opportunities.append([ "23" , "test nom 23" , "3060052" , "2015-08-04" , "Good" , "70" ])
        self.opportunities.append([ "24" , "test nom 24" , "3096395" , "2015-11-25" , "Got it" , "65" ])
        self.opportunities.append([ "25" , "test nom 25" , "1114449" , "2015-10-19" , "No" , "80" ])
        self.opportunities.append([ "26" , "test nom 26" , "2798812" , "2015-01-09" , "Got it" , "20" ])
        self.opportunities.append([ "27" , "test nom 27" , "5570843" , "2015-09-26" , "Good" , "100" ])
        self.opportunities.append([ "28" , "test nom 28" , "37357" , "2015-12-21" , "Good" , "55" ])
        self.opportunities.append([ "29" , "test nom 29" , "5655184" , "2015-05-13" , "No" , "0" ])
        self.opportunities.append([ "30" , "test nom 30" , "5427403" , "2015-12-23" , "Got it" , "80" ])
        self.opportunities.append([ "31" , "test nom 31" , "6088193" , "2015-08-03" , "May be" , "75" ])
        self.opportunities.append([ "32" , "test nom 32" , "7753880" , "2015-07-23" , "Got it" , "20" ])
        self.opportunities.append([ "33" , "test nom 33" , "6438933" , "2015-05-15" , "Good" , "80" ])
        self.opportunities.append([ "34" , "test nom 34" , "7227538" , "2015-06-14" , "No" , "100" ])
        self.opportunities.append([ "35" , "test nom 35" , "6527828" , "2015-11-21" , "Got it" , "55" ])
        self.opportunities.append([ "36" , "test nom 36" , "7127675" , "2015-05-26" , "No" , "95" ])
        self.opportunities.append([ "37" , "test nom 37" , "9209168" , "2015-12-23" , "Got it" , "60" ])
        self.opportunities.append([ "38" , "test nom 38" , "9114577" , "2015-06-02" , "Good" , "55" ])
        self.opportunities.append([ "39" , "test nom 39" , "8632115" , "2015-01-04" , "Good" , "0" ])
        self.opportunities.append([ "40" , "test nom 40" , "5787584" , "2015-02-02" , "May be" , "30" ])
        self.opportunities.append([ "41" , "test nom 41" , "8234059" , "2015-08-24" , "Good" , "70" ])
        self.opportunities.append([ "42" , "test nom 42" , "928890" , "2015-07-01" , "No" , "100" ])
        self.opportunities.append([ "43" , "test nom 43" , "5680165" , "2015-08-09" , "May be" , "40" ])
        self.opportunities.append([ "44" , "test nom 44" , "5379572" , "2015-04-22" , "May be" , "70" ])
        self.opportunities.append([ "45" , "test nom 45" , "2465962" , "2015-02-26" , "Good" , "85" ])
        self.opportunities.append([ "46" , "test nom 46" , "3349804" , "2015-05-19" , "No" , "85" ])
        self.opportunities.append([ "47" , "test nom 47" , "4491888" , "2015-05-05" , "Good" , "35" ])
        self.opportunities.append([ "48" , "test nom 48" , "2908736" , "2015-12-07" , "Got it" , "15" ])
        self.opportunities.append([ "49" , "test nom 49" , "535145" , "2015-10-18" , "Got it" , "20" ])
        self.opportunities.append([ "50" , "test nom 50" , "5986190" , "2015-01-04" , "Got it" , "65" ])
        self.opportunities.append([ "51" , "test nom 51" , "8685962" , "2015-11-11" , "Good" , "90" ])
        self.opportunities.append([ "52" , "test nom 52" , "6820324" , "2015-03-10" , "Good" , "55" ])
        self.opportunities.append([ "53" , "test nom 53" , "5744826" , "2015-12-20" , "Got it" , "70" ])
        self.opportunities.append([ "54" , "test nom 54" , "7482423" , "2015-06-06" , "No" , "10" ])
    }
    ...
    func remplirTableauOpportunities() -> [OpportunityModel] {
        ...
        for opportunity in self.opportunities {
            ...
            var percentageOpportunity: Int  = opportunity[5].toInt()!
            opportunityModel = OpportunityModel(idOpportunite: idOpportunite, nomOpportunite: nomOpportunite, contractValueOpportunite: contractValueOpportunite, closeDateOpportunity: closeDateOpportunity, statusOpportunity: statusOpportunity, percentageOpportunity: percentageOpportunity)
    ...
    func remplirTasks(){
        self.tasks.append([ "2" , "sujet task 2" , "2015-01-26" , "No" ])
        self.tasks.append([ "3" , "sujet task 3" , "2015-05-25" , "No" ])
        self.tasks.append([ "4" , "sujet task 4" , "2015-10-18" , "No" ])
        self.tasks.append([ "5" , "sujet task 5" , "2015-04-06" , "Good" ])
        self.tasks.append([ "6" , "sujet task 6" , "2015-09-01" , "May be" ])
        self.tasks.append([ "7" , "sujet task 7" , "2015-02-10" , "No" ])
        self.tasks.append([ "8" , "sujet task 8" , "2015-04-22" , "Got it" ])
        self.tasks.append([ "9" , "sujet task 9" , "2015-05-01" , "Good" ])
        self.tasks.append([ "10" , "sujet task 10" , "2015-04-02" , "May be" ])
        self.tasks.append([ "11" , "sujet task 11" , "2015-04-18" , "No" ])
        self.tasks.append([ "12" , "sujet task 12" , "2015-07-24" , "No" ])
        self.tasks.append([ "13" , "sujet task 13" , "2015-07-26" , "No" ])
        self.tasks.append([ "14" , "sujet task 14" , "2015-07-25" , "No" ])
        self.tasks.append([ "15" , "sujet task 15" , "2015-12-20" , "Got it" ])
        self.tasks.append([ "16" , "sujet task 16" , "2015-08-17" , "No" ])
        self.tasks.append([ "17" , "sujet task 17" , "2015-05-08" , "Good" ])
        self.tasks.append([ "18" , "sujet task 18" , "2015-10-02" , "Good" ])
        self.tasks.append([ "19" , "sujet task 19" , "2015-05-16" , "May be" ])
        self.tasks.append([ "20" , "sujet task 20" , "2015-01-08" , "Good" ])
        self.tasks.append([ "21" , "sujet task 21" , "2015-03-07" , "Got it" ])
        self.tasks.append([ "22" , "sujet task 22" , "2015-11-27" , "Good" ])
        self.tasks.append([ "23" , "sujet task 23" , "2015-01-08" , "No" ])
        self.tasks.append([ "24" , "sujet task 24" , "2015-01-09" , "May be" ])
        self.tasks.append([ "25" , "sujet task 25" , "2015-06-12" , "May be" ])
        self.tasks.append([ "26" , "sujet task 26" , "2015-10-21" , "May be" ])
        self.tasks.append([ "27" , "sujet task 27" , "2015-04-03" , "No" ])
        self.tasks.append([ "28" , "sujet task 28" , "2015-04-18" , "May be" ])
        self.tasks.append([ "29" , "sujet task 29" , "2015-10-23" , "Good" ])
        self.tasks.append([ "30" , "sujet task 30" , "2015-03-05" , "No" ])
        self.tasks.append([ "31" , "sujet task 31" , "2015-06-06" , "Got it" ])
        self.tasks.append([ "32" , "sujet task 32" , "2015-01-07" , "Good" ])
        self.tasks.append([ "33" , "sujet task 33" , "2015-04-16" , "No" ])
        self.tasks.append([ "34" , "sujet task 34" , "2015-07-20" , "Got it" ])
        self.tasks.append([ "35" , "sujet task 35" , "2015-02-10" , "Good" ])
        self.tasks.append([ "36" , "sujet task 36" , "2015-07-27" , "No" ])
        self.tasks.append([ "37" , "sujet task 37" , "2015-09-14" , "No" ])
        self.tasks.append([ "38" , "sujet task 38" , "2015-07-12" , "Got it" ])
        self.tasks.append([ "39" , "sujet task 39" , "2015-05-24" , "Good" ])
        self.tasks.append([ "40" , "sujet task 40" , "2015-09-09" , "Good" ])
        self.tasks.append([ "41" , "sujet task 41" , "2015-05-12" , "Good" ])
        self.tasks.append([ "42" , "sujet task 42" , "2015-02-08" , "May be" ])
        self.tasks.append([ "43" , "sujet task 43" , "2015-04-22" , "Got it" ])
        self.tasks.append([ "44" , "sujet task 44" , "2015-05-21" , "No" ])
        self.tasks.append([ "45" , "sujet task 45" , "2015-09-27" , "Got it" ])
        self.tasks.append([ "46" , "sujet task 46" , "2015-02-08" , "Got it" ])
        self.tasks.append([ "47" , "sujet task 47" , "2015-12-08" , "Good" ])
        self.tasks.append([ "48" , "sujet task 48" , "2015-11-12" , "Got it" ])
        self.tasks.append([ "49" , "sujet task 49" , "2015-02-24" , "No" ])
        self.tasks.append([ "50" , "sujet task 50" , "2015-05-16" , "Good" ])
        self.tasks.append([ "51" , "sujet task 51" , "2015-02-18" , "No" ])
        self.tasks.append([ "52" , "sujet task 52" , "2015-07-22" , "Got it" ])
        self.tasks.append([ "53" , "sujet task 53" , "2015-02-25" , "Good" ])
        self.tasks.append([ "54" , "sujet task 54" , "2015-07-04" , "Got it" ])
