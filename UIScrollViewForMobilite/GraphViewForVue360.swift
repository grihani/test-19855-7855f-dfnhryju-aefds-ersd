...
class GraphViewForVue360: UIView {
    ...
    @IBInspectable var colorForFirstBar: UIColor = UIColor.blackColor()
    @IBInspectable var colorForSecondBar: UIColor = UIColor.redColor()
    @IBInspectable var colorForLine: UIColor = UIColor.greenColor()
    @IBInspectable var colorForActualMonth: UIColor = UIColor.grayColor()
    @IBInspectable var colorForSelectedMonth: UIColor = UIColor.blueColor()
...
//        graphForSelectedMonth.fillWithBlendMode(kCGBlendModeNormal, alpha: 0.1)
