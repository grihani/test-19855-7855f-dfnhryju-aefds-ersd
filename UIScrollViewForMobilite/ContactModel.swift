...
class ContactModel {
    ...
    init(idContact: Int, jobTitleContact: String, countryContact: String, civilityContact: String, firstNameContact: String, lastNameContact: String, typeContact: String, birthdateContact: String, phoneBusinessContact: String, phoneMobileContact: String, emailContact: String, preferredLanguageContact: String, workingAdressContact: String, linkedinProfileContact: String, idContact1: Int) {
